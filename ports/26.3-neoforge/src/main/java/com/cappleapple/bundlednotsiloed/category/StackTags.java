...
public final class StackTags {
    ...
    public static boolean is(ItemStack stack, Identifier tag) {
    ...
    public static Stream<Identifier> locations(ItemStack stack) {
        ...
        Stream<Identifier> blockTags = blockItem.getBlock().builtInRegistryHolder().tags().map(TagKey::location);
