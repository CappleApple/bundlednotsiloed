...
public final class ClientKeyMappings {
    ...
    public static final KeyMapping SEARCH_BROWSER = new KeyMapping("key.bundlednotsiloed.search_browser",
            KeyConflictContext.GUI, KeyModifier.SHIFT, InputConstants.Type.KEYBOARD, com.mojang.blaze3d.platform.InputConstants.KEY_F, CATEGORY);
    ...
    public static final KeyMapping DUMP_TO_CONTAINER = new KeyMapping("key.bundlednotsiloed.dump_to_container",
            KeyConflictContext.UNIVERSAL, KeyModifier.CONTROL, InputConstants.Type.KEYBOARD, com.mojang.blaze3d.platform.InputConstants.KEY_G, CATEGORY);
    public static final KeyMapping EXTRACT_FROM_CONTAINER = new KeyMapping("key.bundlednotsiloed.extract_from_container",
            KeyConflictContext.UNIVERSAL, KeyModifier.CONTROL, InputConstants.Type.KEYBOARD, com.mojang.blaze3d.platform.InputConstants.KEY_H, CATEGORY);
    public static final KeyMapping TOGGLE_AUTO_REFILL = new KeyMapping("key.bundlednotsiloed.toggle_auto_refill",
            KeyConflictContext.UNIVERSAL, KeyModifier.NONE, InputConstants.Type.KEYBOARD, InputConstants.UNKNOWN.getValue(), CATEGORY);
