...
class InventoryPayloadCodecTest {
    ...
    static void bootstrap() {
        ...
        Bootstrap.bootStrap(); com.cappleapple.bundlednotsiloed.TestBootstrap.bindComponents();
    }
    ...
    void stowAndInventoryPreferencePayloadsRoundTrip() {
        ...
        try {
            ...
            Identifier recipeId = Identifier.fromNamespaceAndPath("minecraft", "wooden_pickaxe");
    ...
    void playerCustomizationRoundTripsAsADefensiveNbtCopy() {
        ...
        try {
            ...
            assertEquals("NAME_ASCENDING", decoded.data().getStringOr("InventorySortPreference", ""));
        } finally {
            buffer.release();
        }
    }
