...
public final class InventoryNetworkGameTests {
    public InventoryNetworkGameTests() {}
    ...
    public static void sophisticatedHoverContextAndOpenItemStayStable(GameTestHelper helper) throws ReflectiveOperationException {
        ...
        ItemStack backpack = new ItemStack(BuiltInRegistries.ITEM.get(
                new ResourceLocation("sophisticatedbackpacks:netherite_backpack")));
        ...
        com.cappleapple.bundlednotsiloed.platform.GameTestAssertions.equal(helper, ((LogicalBackpackContext)context).bns$logicalBackpackSlot(), 42,
        ...
        InventorySyncPreflight.validate(player.level().registryAccess(), data.inventory().vanillaStackReference(42));
        ...
        com.cappleapple.bundlednotsiloed.platform.GameTestAssertions.equal(helper, OpenBackpackGuard.logicalSlot(player), 42, "Open backpack root was not protected");
        ...
        ItemStack child = new ItemStack(BuiltInRegistries.ITEM.get(new ResourceLocation("sophisticatedbackpacks:backpack")));
        ...
        com.cappleapple.bundlednotsiloed.platform.GameTestAssertions.equal(helper, OpenBackpackGuard.logicalSlot(player), 42, "Nested backpack lost its root item lock");
