# Validation: 1.21.1-fabric

Validated locally on 2026-09-19:

- 111 Bundled Not Siloed unit tests passed.
- 35 Stacks Not Slots unit tests passed.
- 12 required server GameTests passed, including the vanilla baseline where registered by the loader.
