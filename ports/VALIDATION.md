# Validation: 1.20.1-forge

Validated locally on 2026-09-19:

- 110 Bundled Not Siloed unit tests passed.
- 33 Stacks Not Slots unit tests passed.
- 11 required server GameTests passed, including the vanilla baseline where registered by the loader.
