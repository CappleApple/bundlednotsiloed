# Validation: 26.3-neoforge - 2026-09-20
...
| --- | ---: | ---: | ---: | --- | --- |
| 26.3-neoforge | 112 | 35 | 10 | Passed | Passed |
...
Build the matching dependency first. Place a disposable world at `ports/26.3-neoforge/run-client-smoke/saves/BNS-Audit/`; the `level.dat` file must be directly inside that directory. The gameplay fixture replaces the test player's inventory, so use a copied test world. From the target directory, run:
