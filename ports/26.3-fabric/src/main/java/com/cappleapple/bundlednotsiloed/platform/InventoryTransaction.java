...
public final class InventoryTransaction extends SnapshotParticipant<InventorySnapshot> {
    ...
    private final com.cappleapple.bundlednotsiloed.data.PlayerInventoryData data;
    public InventoryTransaction(com.cappleapple.bundlednotsiloed.data.PlayerInventoryData data) { this.data = data; this.inventory = data.inventory(); }
    ...
    @Override protected void readSnapshot(InventorySnapshot snapshot) { inventory.applySnapshot(snapshot); data.syncVanillaCompatibilityView(); }
