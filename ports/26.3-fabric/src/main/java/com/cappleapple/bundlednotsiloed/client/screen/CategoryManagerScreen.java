...
public final class CategoryManagerScreen extends Screen {
    ...
    private void rebuildButtons() {
        ...
        addRenderableWidget(Button.builder(Component.translatable("gui.bundlednotsiloed.reset_defaults"), ignored ->
                        com.cappleapple.bundlednotsiloed.platform.PacketDistributor.sendToServer(new CategoryEditPayload(CategoryEditPayload.Operation.RESET, new net.minecraft.nbt.CompoundTag())))
    ...
    private void bindSelected(CategoryDefinition category) {
        ...
        com.cappleapple.bundlednotsiloed.platform.PacketDistributor.sendToServer(new HotbarBindPayload(selectedHotbar, binding.type(),
    ...
    private void remove(CategoryDefinition category) {
        ...
        com.cappleapple.bundlednotsiloed.platform.PacketDistributor.sendToServer(new CategoryEditPayload(CategoryEditPayload.Operation.DELETE, tag));
    }
    ...
    private static void send(CategoryDefinition category) {
        com.cappleapple.bundlednotsiloed.platform.PacketDistributor.sendToServer(new CategoryEditPayload(CategoryEditPayload.Operation.UPSERT, PlayerCategoryData.saveCategory(category)));
    }
}
