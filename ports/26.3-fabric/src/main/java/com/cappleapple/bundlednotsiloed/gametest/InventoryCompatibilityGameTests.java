...
public final class InventoryCompatibilityGameTests {
    ...
    public void clearVisitsHiddenLogicalStorage(GameTestHelper helper) {
    ...
    @GameTest(structure = "fabric-gametest-api-v1:empty")
    public void creativePickAndPlacementUseLogicalStorage(GameTestHelper helper) {
    ...
    @GameTest(structure = "fabric-gametest-api-v1:empty")
    public void creativeCursorTransactionsUseHiddenStorage(GameTestHelper helper) {
        Player player = migratedPlayer(helper, GameType.CREATIVE);
        DynamicCapacityInventory inventory = ModAttachments.get(player).inventory();
        AttributeInstance capacity = player.getAttribute(ModAttributes.INVENTORY_CAPACITY);
        helper.assertTrue(capacity != null, "Inventory capacity attribute was missing");
    ...
    @GameTest(structure = "fabric-gametest-api-v1:empty")
    public void externalQuickMoveHonorsSelectedNewItemDestination(GameTestHelper helper) {
        Player player = migratedPlayer(helper, GameType.SURVIVAL);
        PlayerInventoryData data = ModAttachments.get(player);
        DynamicCapacityInventory inventory = data.inventory();
    ...
    @GameTest(structure = "fabric-gametest-api-v1:empty")
    public void playerInventoryQuickMoveUsesDirectionBySource(GameTestHelper helper) {
        Player player = migratedPlayer(helper, GameType.SURVIVAL);
        DynamicCapacityInventory inventory = ModAttachments.get(player).inventory();
    ...
    @GameTest(structure = "fabric-gametest-api-v1:empty")
    public void recipeInventoryHooksDetectAndExtractStowedIngredients(GameTestHelper helper) {
        Player player = migratedPlayer(helper, GameType.SURVIVAL);
        PlayerInventoryData data = ModAttachments.get(player);
        DynamicCapacityInventory inventory = data.inventory();
