...
class InventoryPayloadCodecTest {
    ...
    static void bootstrap() {
        ...
        com.cappleapple.bundlednotsiloed.ForgeTestBootstrap.initializeEventLists(); Bootstrap.bootStrap();
    }
    ...
    void stowAndInventoryPreferencePayloadsRoundTrip() {
        ...
        try {
            ...
            ResourceLocation recipeId = new ResourceLocation("minecraft", "wooden_pickaxe");
    ...
    void browserStateAndBulkTransfersRoundTrip() {
        ...
        try {
            ...
            assertSame(Items.STONE, result.stacks().get(0).prototype().getItem());
            assertEquals(130, result.stacks().get(0).quantity());
        } finally {
            buffer.release();
        }
    }
