...
public final class ClientTooltipSearchIndex {
    ...
    public static String text(ItemStack stack) {
        ...
        if (!ClientConfig.TOOLTIP_INDEXING.get() || minecraft.player == null || stack.isEmpty()) return "";
        return CACHE.computeIfAbsent(new SearchIdentity(stack), ignored ->
                stack.getTooltipLines(minecraft.player,
    ...
    private static final class SearchIdentity {
        ...
        @Override public boolean equals(Object other) {
            return other instanceof SearchIdentity identity && ItemStack.isSameItemSameTags(stack, identity.stack);
        }
    }
}
