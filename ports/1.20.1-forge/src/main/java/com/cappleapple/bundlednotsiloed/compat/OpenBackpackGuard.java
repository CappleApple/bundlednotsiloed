...
public final class OpenBackpackGuard {
    ...
    public static boolean protects(Player player, ItemStack stack) {
        ...
        return slot >= 0 && !stack.isEmpty() && ItemStack.isSameItemSameTags(
                com.cappleapple.bundlednotsiloed.data.ModAttachments.get(player).inventory().vanillaStackReference(slot), stack);
    }
