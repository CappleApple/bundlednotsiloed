...
public final class PlayerInventoryData {
    ...
    private com.cappleapple.bundlednotsiloed.compat.LogicalPlayerStorage fabricStorage;
    public com.cappleapple.bundlednotsiloed.compat.LogicalPlayerStorage fabricStorage(net.fabricmc.fabric.api.transfer.v1.item.PlayerInventoryStorage original) {
        if (fabricStorage == null) fabricStorage = new com.cappleapple.bundlednotsiloed.compat.LogicalPlayerStorage(owner, original);
