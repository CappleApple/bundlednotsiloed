...
public final class CategoryIcons {
    public static final Identifier DYNAMIC_ICON = BundledNotSiloed.id("dynamic_icon");
    ...
    public static Identifier parseIcon(String input) {
    ...
    public static String formatIcon(Identifier icon) {
    ...
    private static CategoryRule decodeTagIcon(Identifier icon) {
        ...
        Identifier target = Identifier.tryBuild(encoded.substring(0, separator), encoded.substring(separator + 1));
