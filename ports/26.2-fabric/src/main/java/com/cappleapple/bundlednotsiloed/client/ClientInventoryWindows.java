...
public final class ClientInventoryWindows {
    ...
    public static void open() {
        ...
        com.cappleapple.bundlednotsiloed.platform.PacketDistributor.sendToServer(new BrowserStatePayload(true, state.session(), state.containerId()));
    }
    public static void close() {
        if (state == null) return;
        com.cappleapple.bundlednotsiloed.platform.PacketDistributor.sendToServer(new BrowserStatePayload(false, state.session(), state.containerId()));
        reset();
    }
    ...
    private static void sendDesired() {
        ...
        if (request != null) com.cappleapple.bundlednotsiloed.platform.PacketDistributor.sendToServer(request);
    }
