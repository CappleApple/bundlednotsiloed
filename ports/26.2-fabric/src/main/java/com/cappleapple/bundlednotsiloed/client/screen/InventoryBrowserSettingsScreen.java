...
public final class InventoryBrowserSettingsScreen extends Screen {
    ...
    protected void init() {
        ...
        autoRefill = minecraft.player == null
                || ModAttachments.get(minecraft.player).autoRefill();
        if (minecraft.player != null) {
            newItemDestination = ModAttachments.get(minecraft.player).newItemDestination();
        }
    ...
    private void saveAndClose() {
        ...
        if (minecraft.player != null) {
            ...
            com.cappleapple.bundlednotsiloed.platform.PacketDistributor.sendToServer(new AutoRefillPayload(autoRefill));
            com.cappleapple.bundlednotsiloed.platform.PacketDistributor.sendToServer(new NewItemDestinationPayload(newItemDestination));
        }
