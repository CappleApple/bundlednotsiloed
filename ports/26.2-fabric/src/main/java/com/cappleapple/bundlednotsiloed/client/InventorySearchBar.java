...
public final class InventorySearchBar {
    ...
    public static void renderButton(GuiGraphicsExtractor graphics, int x, int y, boolean highlighted) {
        InventoryBrowserControls.renderButtonBackground(graphics, x, y, highlighted);
        graphics.blit(net.minecraft.client.renderer.RenderPipelines.GUI_TEXTURED, SEARCH_ICON, x + 2, y + 2, 8, 8,
