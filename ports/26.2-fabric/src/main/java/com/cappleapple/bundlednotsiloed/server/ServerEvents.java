...
public final class ServerEvents {
    ...
    private static void migrateVanillaInventory(ServerPlayer player, PlayerInventoryData data) {
        ...
        for (ItemStack stack : player.getInventory().getNonEquipmentItems()) if (!stack.isEmpty()) vanillaStacks.add(stack.copy());
        ...
        BundledNotSiloed.LOGGER.info("Migrated {} vanilla inventory stacks for {}", vanillaStacks.size(), player.getGameProfile().name());
    }
}
