...
public final class InventoryBrowserSettingsScreen extends Screen {
    ...
    private void saveAndClose() {
        ...
        if (minecraft.player != null) {
            ...
            net.neoforged.neoforge.client.network.ClientPacketDistributor.sendToServer(new AutoRefillPayload(autoRefill));
            net.neoforged.neoforge.client.network.ClientPacketDistributor.sendToServer(new NewItemDestinationPayload(newItemDestination));
        }
