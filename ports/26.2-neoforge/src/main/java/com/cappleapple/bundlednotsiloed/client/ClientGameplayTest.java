...
public final class ClientGameplayTest {
    ...
    private static void click(Screen screen,double x,double y,int button) {screen.mouseClicked(new net.minecraft.client.input.MouseButtonEvent(x,y,new net.minecraft.client.input.MouseButtonInfo(button,0)),false);}
