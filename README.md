...
- Native-style player inventory replacement with a left-side search/category/settings rail, a synchronized real-slot 9-by-3 viewport, transient capacity feedback, and conditional row scrolling
