...
The built mod is written to `build/libs/bundlednotsiloed-1.0.jar`. The project uses official Mojang mappings with Parchment parameter names and ModDevGradle's Minecraft-aware JUnit support.
